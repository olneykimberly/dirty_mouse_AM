...
cd /tgen_labs/jfryer/projects/dirty_mice/AM/bulkRNA
...
# mv the files 
mv R1Samples.txt  /tgen_labs/jfryer/kolney/dirty_mice/dirty_mouse_AM/scripts/R1Samples.txt
mv sampleReadInfo.txt /tgen_labs/jfryer/kolney/dirty_mice/dirty_mouse_AM/scripts/sampleReadInfo.txt

cd /tgen_labs/jfryer/kolney/dirty_mice/dirty_mouse_AM/scripts/
