#!/bin/bash
#SBATCH --job-name=dirty_AM_processing                                                              
#SBATCH --time=10:00:00                               
#SBATCH --mem=2G
#SBATCH -n 8 # threaded 
#SBATCH --cpus-per-task=1
#SBATCH -o slurm.dirty_AM_processing.job.%j.out
#SBATCH -e slurm.dirty_AM_processing.job.%j.err
...
CWD="/tgen_labs/jfryer/kolney/dirty_mice/dirty_mouse_AM/scripts"
cd $CWD
